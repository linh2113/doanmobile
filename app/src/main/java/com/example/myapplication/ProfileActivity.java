            ...
            public void onClick(View v) {
                ...
                if (!newUsername.isEmpty()) {
                    if(newUsername.equals(currentUsername)){
                        Toast.makeText(ProfileActivity.this, "Tên mới không được trùng với tên hiện tại", Toast.LENGTH_SHORT).show();
                        return;
                    }
                    ...
                    Toast.makeText(ProfileActivity.this, "Đổi tên người dùng thành công", Toast.LENGTH_SHORT).show();
                    newName.setText("");
                } else {
                    Toast.makeText(ProfileActivity.this, "Tên mới không được để trống", Toast.LENGTH_SHORT).show();
                }
            }
        });
            ...
            public void onClick(View v) {
                ...
                if (!currentPasswordText.isEmpty() && !newPasswordText.isEmpty() && !confirmNewPasswordText.isEmpty()) {
                    if(currentPasswordText.equals(newPasswordText)){
                        Toast.makeText(ProfileActivity.this, "Mật khẩu mới không được trùng với mật khẩu cũ", Toast.LENGTH_SHORT).show();
                        return;
                    }
                    ...
                    Toast.makeText(ProfileActivity.this, "Các trường mật khẩu không được để trống", Toast.LENGTH_SHORT).show();
                }
            }
        });
